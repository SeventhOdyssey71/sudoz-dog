...
import { ArrowLeft, Wallet, Search, Filter, Grid, List, Sparkles, FlaskConical, Zap, AlertTriangle, CheckCircle, Loader2 } from "lucide-react";
        ...
        <div className="text-center mb-8">
          ...
          <div className="flex justify-center items-center space-x-8 mt-6">
            <div className="text-center">
              <div className="text-2xl font-bold text-green-400">{artifacts.length}</div>
              <div className="text-sm text-gray-400">ARTIFACTS</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-purple-400">{evolvedNFTs.length}</div>
              <div className="text-sm text-gray-400">EVOLVED</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-cyan-400">{totalNFTs}</div>
          ...
          <div className="space-y-8">
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              ...
              <TabsContent value="evolved" className="mt-6">
                {filteredEvolved.length === 0 ? (
                  <div className="text-center py-8">
                    <FlaskConical className="w-12 h-12 text-purple-400 mx-auto mb-4" />
                    <p className="text-gray-400">No evolved entities found.</p>
                    <p className="text-gray-400 text-sm mt-2">Evolve level 10 artifacts to create evolved entities.</p>
                  </div>
                ) : (
                  <div className={viewMode === "grid" 
                    ? "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6"
